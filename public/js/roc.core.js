var roc = (function() {
	...
	return {
		...
		getSkipValue: function(entity) {
			return skip[entity];
		},
		setSkipValue: function(val, entity) {
			skip[entity] = skip[entity] ? skip[entity] + val : val;
		},
		resetSkipValue: function(entity) {
			skip[entity] = 0;
		},
		getLimitValue: function(entity) {
			return limit[entity];
		},
		setLimitValue: function(val, entity) {
			limit[entity] = val;
		}
	};
}());
